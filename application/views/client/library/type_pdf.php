...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/css/client/library_general.css">
...
<body>
    ...
    <div class="row" style="display: flex; justify-content: space-around; align-items: center; color: white; padding-bottom: 20px;">
        ...
        <div class="col-md-10">
            <p style="font-weight: bold; font-size: large; margin-left: 35%;">Biblioteca</p>
        </div>
    </div>
    <div class="container">
        <div class="row gx-5" id="pdf" style="margin: 0 auto; max-width: 800px;">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Cargando documento...</h5>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    function getTrainingDetails() {
        ...
        const pdf_url = localStorage.getItem('pdf');
        ...
        pdf.innerHTML = `
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">
                            <embed src="${pdf_url}" type="application/pdf" width="100%" height="500px" />
                        </h5>
                    </div>
                </div>
            </div>
