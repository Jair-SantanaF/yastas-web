...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/css/client/news.css">
...
<body>
    ...
    <div class="row" style="display: flex; justify-content: space-around; align-items: center; color: white; padding-bottom: 20px;">
        ...
        <div class="col-md-10">
            <p style="font-weight: bold; font-size: large; margin-left: 35%;">Noticias</p>
        </div>
    </div>
    <div class="container">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body" id="news">
                        <h5 class="card-title">Cargando noticias...</h5>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    $(document).ready(function() {
        ...
        getFullNews(business_id, user_id);
    });
</script>