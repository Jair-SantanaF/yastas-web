...
function ObtenerTablaElementos(record) {
    ...
    console.log($('#selected_group_id').val())
    //Se crea la tabla con eyuda del plugin DataTable
    tabla_pending = $('#tabla_pending').DataTable({
        ...
        "order": [[0, "asc"]],
        "ajax": {
            url: "../index.php/Groups/PodcastGroups",
            type: 'POST',
            data: function (d) {
...
function EliminarElemento(record) {
    Swal.fire({
        ...
        if (result.value) {
            $.ajax({
                url: window.base_url + "Groups/DeletePodcast",
                type: "POST",
                data: {
                    id: record.id
                },
...
function ObtenerTablaElementosNoAsignados(record) {
    ...
    tabla_elements = $('#tabla_elements').DataTable({
        ...
        "order": [[1, "asc"]],
        "ajax": {
            url: "../index.php/Groups/NoPodcastGroups",
            type: 'POST',
            data: function (d) {
                d.group_id = $('#selected_group_id').val();
            },
...
function AgregarElementos() {
    ...
    // return
    $.ajax({
        url: window.base_url + "Groups/SavePodcast",
        type: "POST",
        data: data,
        cache: false,
        success: function (response) {
